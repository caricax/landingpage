...
# Copiar arquivos compilados para o nginx
COPY dist/caricax-landing/browser /usr/share/nginx/html

# Criar configuração customizada do nginx para SPAs
...
# Expor porta 8080 (required by Cloud Run)
EXPOSE 8080
